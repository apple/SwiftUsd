...
let package = Package(
    ...
    targets: [
        ...
        .plugin(name: "generate-plug-info-json",
                ...
                path: "swift-package/Plugins/generate-plug-info-json"),
        ...
        .plugin(name: "build-vanilla-openusd-plugin",
                ...
                path: "swift-package/Plugins/build-vanilla-openusd-plugin"),
...
func cppTarget_dependencies() -> [Target.Dependency] {
    [
        ...
        .target(name: "_MaterialXGenHw_xcframework", condition: .when(platforms: [.macOS])),
        ...
        .target(name: "_Usd_UsdExecImaging_xcframework", condition: .when(platforms: [.iOS, .macOS, .visionOS])),
        ...
        .target(name: "_Usd_UsdIrImaging_xcframework", condition: .when(platforms: [.iOS, .macOS, .visionOS])),
        .target(name: "_Usd_UsdLod_xcframework", condition: .when(platforms: [.iOS, .macOS, .visionOS])),
        .target(name: "_Usd_UsdLux_xcframework", condition: .when(platforms: [.iOS, .macOS, .visionOS])),
        .target(name: "_Usd_UsdLuxValidators_xcframework", condition: .when(platforms: [.iOS, .macOS, .visionOS])),
        ...
        .target(name: "_Usd_UsdProfiles_xcframework", condition: .when(platforms: [.iOS, .macOS, .visionOS])),
        ...
        .target(name: "_embree4_xcframework", condition: .when(platforms: [.iOS, .macOS, .visionOS])),
        .target(name: "_hdEmbree_xcframework", condition: .when(platforms: [.iOS, .macOS, .visionOS])),
...
func xcframeworkBinaryTargets() -> [Target] {
    [
        ...
        .binaryTarget(name: "_MaterialXGenHw_xcframework", path: "swift-package/Libraries/MaterialXGenHw.xcframework"),
        ...
        .binaryTarget(name: "_Usd_UsdExecImaging_xcframework", path: "swift-package/Libraries/Usd_UsdExecImaging.xcframework"),
        ...
        .binaryTarget(name: "_Usd_UsdIrImaging_xcframework", path: "swift-package/Libraries/Usd_UsdIrImaging.xcframework"),
        .binaryTarget(name: "_Usd_UsdLod_xcframework", path: "swift-package/Libraries/Usd_UsdLod.xcframework"),
        .binaryTarget(name: "_Usd_UsdLux_xcframework", path: "swift-package/Libraries/Usd_UsdLux.xcframework"),
        .binaryTarget(name: "_Usd_UsdLuxValidators_xcframework", path: "swift-package/Libraries/Usd_UsdLuxValidators.xcframework"),
        ...
        .binaryTarget(name: "_Usd_UsdProfiles_xcframework", path: "swift-package/Libraries/Usd_UsdProfiles.xcframework"),
