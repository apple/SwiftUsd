...
> Important: Tested with OpenUSD v26.05, Xcode 26.5 (17F42) on macOS 26.5 (17F42), iPadOS 26.0 (23A341), and visionOS 26.1 (23N49).
...
```swift
dependencies: [
    .package(url: "https://github.com/apple/SwiftUsd", from: "7.0.1"),
]
```
