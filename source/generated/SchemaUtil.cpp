...
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolVolumeFieldAsset& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolFieldBase& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolVolumeFieldBase& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolOpenVDBAsset& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleField& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleField3DGaussianSplat& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldPositionAttributeAPI& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldPositionBaseAPI& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldOrientationAttributeAPI& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldScaleAttributeAPI& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldOpacityAttributeAPI& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldKernelGaussianEllipsoidAPI& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldKernelBaseAPI& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldSphericalHarmonicsAttributeAPI& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldRadianceBaseAPI& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldKernelConstantSurfletAPI& x) { return x.GetPrim(); }
pxr::UsdPrim Overlay::GetPrim(const pxr::UsdVolParticleFieldKernelGaussianSurfletAPI& x) { return x.GetPrim(); }
...
bool __Overlay::convertToBool(const pxr::UsdVolVolumeFieldAsset& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolFieldBase& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolVolumeFieldBase& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolOpenVDBAsset& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleField& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleField3DGaussianSplat& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldPositionAttributeAPI& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldPositionBaseAPI& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldOrientationAttributeAPI& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldScaleAttributeAPI& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldOpacityAttributeAPI& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldKernelGaussianEllipsoidAPI& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldKernelBaseAPI& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldSphericalHarmonicsAttributeAPI& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldRadianceBaseAPI& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldKernelConstantSurfletAPI& x) { return (bool)x; }
bool __Overlay::convertToBool(const pxr::UsdVolParticleFieldKernelGaussianSurfletAPI& x) { return (bool)x; }
